...
import src2 from './images/last bannerpic.jpg'
const carsole = () => {
  return (
    <div id="carsole">
<div className='about d-flex'>
<h1   id='h2'> 02.ABOUT</h1>
...
<h1>Short Paragraph on Restaurant
</h1>
<p>T
...
The restaurant A restaurant is a place where people visit to eat and drink the food being prepared on the premises and pays for the same. The food is served at the table to have a comfortable visit for your meals. The restaurant offers a menu with various options for your meal, to choose from.
